...
This is a more-focused geospatial analysis of unemployment rates in the census tracts chosen specifically by developers compared with the tracts they originally pitched to the state. They pitched 26 census tracts to be included but 23 percent of them did not exist. They also mistakenly thought the project site was on census tract 26, which also does not exist in Hudson county.
